...
import classes from './earphone_card.module.css';

const DEFAULT_IMAGE = '/periphs/earphone.jpg';

export function EarphoneCard({ product }: { product: Earphone }) {
	const { wire, microOnWire, product: productData } = product;
	return (
